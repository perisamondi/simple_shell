...
/* Will prompt Prompt to be printed */
#define PROMPT_MSG "dali<3 " /* Is needed to work with the signal */

/* Will resume from the unused attibute */
#define UNUSED __attribute__((unused))

/* will get buffer size for each read call in _getline */
